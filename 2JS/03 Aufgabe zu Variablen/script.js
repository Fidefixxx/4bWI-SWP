...
console.log("Preis von 1 Tonne Äpfel: " + avgAppleWeight * 1000  * applePricePerKilo)
// Preis von 1 Tonne Bananen
console.log("Preis von 1 Tonne Bananen: " + avgBananaWeight * 1000  * bananaPricePerKilo)
